  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers = {
      code-server = svc.mkContainer {
        cfg = {
          image = "ghcr.io/coder/code-server:4.98.0@sha256:49190032f1ab73cdcd0c930b1e961c20110aa1b6004d296c14681eb11c9f49d8";
          user = "65000:65000";
          cmd = [
            "--auth"
            "none"
      ...
      home-assistant = svc.mkContainer {
        cfg = {
          image = "ghcr.io/onedr0p/home-assistant:2025.3.3@sha256:16f8597335dde4ab385069b23f3fbfd46911a4ff356c7f2acf3680c429e2d8d7";
          user = "65000:65000";
