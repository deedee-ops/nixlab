  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers = {
      code-server = svc.mkContainer {
        cfg = {
          image = "ghcr.io/coder/code-server:4.103.2@sha256:f9ed058d6b1a4aa80846f77902d344bd97e450aec69201a0f8939baf58b18a5f";
          user = "65000:65000";
          cmd = [
            "--auth"
            "none"
      ...
      home-assistant = svc.mkContainer {
        cfg = {
          image = "ghcr.io/home-operations/home-assistant:2025.9.0@sha256:762e782f6efc5a3fcf36092b31bef4caf76380b1cf4a3bc12fa85760792af476";
          user = "65000:65000";
