  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers = {
      code-server = svc.mkContainer {
        cfg = {
          image = "ghcr.io/coder/code-server:4.106.0@sha256:fab3f1c339440d598ab32f0f234033ed6567847107e01ab43975988554934695";
          user = "65000:65000";
          cmd = [
            "--auth"
            "none"
      ...
      home-assistant = svc.mkContainer {
        cfg = {
          image = "ghcr.io/home-operations/home-assistant:2025.11.2@sha256:ff7eb7c296bb514704804a6d68d67e6858edb4366ee38d1c3089e837230a9172";
          user = "65000:65000";
