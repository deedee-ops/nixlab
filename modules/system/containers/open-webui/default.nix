...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers.open-webui = svc.mkContainer {
      cfg = {
        image = "ghcr.io/open-webui/open-webui:main@sha256:d1ffcfc4fa8aa8ef1caf2bf638e1a62ec8c26d25f2279a2279b95fde6502debb";
        environment = {
          WEBUI_AUTH = "True";
      ...
      // lib.optionalAttrs config.myHardware.nvidia.enable {
        image = "ghcr.io/open-webui/open-webui:cuda@sha256:b731f72c6894458c785664357a4164895ece8346e929a3efe5e4aff46c17088d";
      };
