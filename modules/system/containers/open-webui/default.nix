...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers.open-webui = svc.mkContainer {
      cfg = {
        image = "ghcr.io/open-webui/open-webui:main@sha256:88f5a07f802bc4bc8e68252d82d6559e052762d5f12061c3d42f8892a995569e";
        environment = {
          WEBUI_AUTH = "True";
      ...
      // lib.optionalAttrs config.myHardware.nvidia.enable {
        image = "ghcr.io/open-webui/open-webui:cuda@sha256:fbcc95aa89c372c0ba536aa3298a037b95f7b2e1cb5549849667817f8661fa1c";
      };
