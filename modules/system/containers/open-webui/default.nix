...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers.open-webui = svc.mkContainer {
      cfg = {
        image = "ghcr.io/open-webui/open-webui:main@sha256:42fc9cb8be6746a95ad1b6f1b41b009621f8af05f99db2e9c7927a6ff92069a4";
        environment = {
          WEBUI_AUTH = "True";
      ...
      // lib.optionalAttrs config.myHardware.nvidia.enable {
        image = "ghcr.io/open-webui/open-webui:cuda@sha256:ca7cc34f9ebbf650c61232056cb5faa59f0866538a8533b0ec02fa297552091a";
      };
