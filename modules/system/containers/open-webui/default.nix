...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers.open-webui = svc.mkContainer {
      cfg = {
        image = "ghcr.io/open-webui/open-webui:main@sha256:60fa63e738e7dc5e548f26a54d6deac684d6712256a7fae91dd6157ce64bef84";
        environment = {
          WEBUI_AUTH = "True";
      ...
      // lib.optionalAttrs config.myHardware.nvidia.enable {
        image = "ghcr.io/open-webui/open-webui:cuda@sha256:f3314c66f3152574f0a80a9769faf3c267a867ef827687a69862e830d2bc1499";
      };
