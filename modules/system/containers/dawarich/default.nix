...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    services.nginx.virtualHosts.dawarich = svc.mkNginxVHost {
      host = "dawarich";
    ...
    services.postgresqlBackup = lib.mkIf cfg.backup { databases = [ "dawarich" ]; };

    mySystemApps.homepage = {
      services.Media.Prowlarr = svc.mkHomepage "dawarich" // {
