      ...
      forgejo-dind = lib.mkIf cfg.enableRunner (
        svc.mkContainer {
          cfg = {
            ...
            image = "public.ecr.aws/docker/library/docker:dind@sha256:831644212c5bdd0b3362b5855c87b980ea39a83c9e9adcef2ce03eced99a737a";
          };
          opts = {
      ...
      forgejo-runner = lib.mkIf cfg.enableRunner (
        svc.mkContainer {
          cfg = {
            ...
            image = "data.forgejo.org/forgejo/runner:11.1.0@sha256:69ad93bc8928b133a9c8e394c8edfbb69b5991be744570191ebde379102ce17d";
            environment = {
