  ...
  config = lib.mkIf cfg.enable {
    ...
    virtualisation.oci-containers.containers = {
      forgejo = svc.mkContainer {
        cfg = {
          image = "codeberg.org/forgejo/forgejo:14.0.0-rootless@sha256:1a56fc4eeebb2908e422d5447c07fa9c5fd099ab68edf9907723ef3a4546e01c";
      ...
      forgejo-dind = lib.mkIf cfg.enableRunner (
        svc.mkContainer {
          cfg = {
            ...
            image = "public.ecr.aws/docker/library/docker:dind@sha256:3a33fc81fa4d38360f490f5b900e9846f725db45bb1d9b1fe02d849bd42a5cf2";
          };
          opts = {
