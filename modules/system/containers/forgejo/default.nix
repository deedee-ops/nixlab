      ...
      forgejo-dind = lib.mkIf cfg.enableRunner (
        svc.mkContainer {
          cfg = {
            ...
            image = "public.ecr.aws/docker/library/docker:dind@sha256:c0872aae4791ff427e6eda52769afa04f17b5cf756f8267e0d52774c99d5c9de";
          };
          opts = {
      ...
      forgejo-runner = lib.mkIf cfg.enableRunner (
        svc.mkContainer {
          cfg = {
            ...
            image = "data.forgejo.org/forgejo/runner:10.0.0@sha256:e1acf554cced4dd9cb37a5b5b6ff2ec1fd3a665a3264416c9491c209d98546eb";
            environment = {
