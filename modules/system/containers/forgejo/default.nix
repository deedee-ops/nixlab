      ...
      forgejo-dind = lib.mkIf cfg.enableRunner (
        svc.mkContainer {
          cfg = {
            ...
            image = "public.ecr.aws/docker/library/docker:dind@sha256:cf5c79bfb90a1b8ef3947b013fe61b3d66ad790ab4bcf3ee5319e8b88134f553";
          };
          opts = {
      ...
      forgejo-runner = lib.mkIf cfg.enableRunner (
        svc.mkContainer {
          cfg = {
            ...
            image = "data.forgejo.org/forgejo/runner:9.0.1@sha256:06cce8d13144b02738c4b5aacd441c12d8b2d861770913f93f5383c6eebfbf7f";
            environment = {
